...
const SvgFigma = (props: SVGProps<SVGSVGElement>): React.ReactElement => (
  ...
  >
    <g opacity={0.15} fill={props.color || "#000"}>
      <path d="M6 6a3 3 0 0 1 3-3h6a3 3 0 0 1 0 6h-3v9a3 3 0 1 1-3-3 3 3 0 0 1 0-6 3 3 0 0 1-3-3Z" />
      <path d="M12 12a2.999 2.999 0 0 1 5.772-1.148 2.999 2.999 0 0 1-4.893 3.27A3 3 0 0 1 12 12Z" />
    </g>
    <path
      fillRule="evenodd"
      clipRule="evenodd"
