...
const SvgPin = (props: SVGProps<SVGSVGElement>): React.ReactElement => (
  ...
  >
    <path
      ...
      fillRule="evenodd"
      clipRule="evenodd"
      d="M12 3C8.134 3 5 5.97 5 9.635c0 5.015 4.64 9.716 6.364 11.29.36.33.901.32 1.251-.02C14.324 19.248 19 14.283 19 9.636 19 5.97 15.866 3 12 3Zm0 9a2 2 0 1 0 0-4 2 2 0 0 0 0 4Z"
